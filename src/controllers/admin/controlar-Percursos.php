...
if (isset($_GET['info'])) {
    ...
    if ($_GET['info'] == 'deletar') {
        ...
        if ($sucesso) {
            ...
            header('location: /../../../admin/Percursos_Bike_Miradouros/All_Percursos_Bike_Miradouros.php');
        }
    }
}
...
function InserirInfo($requisicao)
{
    ...
    if (isset($dados['invalido'])) {
        ...
        header('location: /../../../admin/Percursos_Bike_Miradouros/All_Percursos_Bike_Miradouros.php' . $params);
    ...
    if ($sucesso) {
        ...
        header('location: /../../../admin/Percursos_Bike_Miradouros/Inserir_Percursos_Bike_Miradouros.php');
    }
}
