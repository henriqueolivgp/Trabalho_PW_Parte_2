   ...
   <div class="container">
    ...
    <div class="row d-flex align-items-center w-100 ">
      ...
      <div class="container-card">
        ...
        <div class="cards p-4 mb-4 col-12">
          <div class="card-img-1"><img class="back-img-1" src="../recursos/IMG/PercursosPedestres/PCR2938.jpg" alt=""></div>
    ...
    <!-- Esta linha e responsavel por ajustar o card-2 -->
    <div class="row d-flex align-items-center w-100 ">
      <!-- Card-2-->
      ...
      <div class="cards p-4 mt-4 col-12">
        <div class="card-img-1"><img class="back-img" src="../recursos/IMG/PercursosPedestres/Imagem005-2.jpg" alt=""></div>
        <div class="card-body-1" style="border: 8px; border-radius: 1rem;">
